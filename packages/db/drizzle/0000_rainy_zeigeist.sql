...
ALTER TABLE "frameworks" ADD CONSTRAINT "frameworks_head_version_hash_framework_versions_content_hash_fk" FOREIGN KEY ("head_version_hash") REFERENCES "public"."framework_versions"("content_hash") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
